...
/* pTextureFilePath : ../Bin/resources/Texture/Explosion/Explosion.png */
...
HRESULT CTexture::Initialize_Prototype(TEXTURE eType, const _tchar* pTextureFilePath, _uint iNumTextures)
{
	...
	for (size_t i = 0; i < iNumTextures; i++)
	{
		...
		/* pTextureFilePath : ../Bin/resources/Texture/Explosion/Explosion%d.png */
		/* szTextureFilePath : ../Bin/resources/Texture/Explosion/Explosioni.png */
